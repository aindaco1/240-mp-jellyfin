...
240-mp-jellyfin is a macOS Apple Silicon fork of 240-MP. It keeps the retro VHS/CRT-style Qt 6 + QML shell, keeps Local, Loop, Retro, Tumblr, and Nature, hides Plex, adds Jellyfin as the primary server-backed module, and adds a Funbox-backed Karaoke queue.
...
- User-facing modules are `jellyfin`, `karaoke`, `retro_tv`, `tumblr_screensaver`, `nature`, `local_files`, and `ambient_mode`, displayed in that order as Jellyfin, Karaoke, Retro, Tumblr, Nature, Local, and Loop.
